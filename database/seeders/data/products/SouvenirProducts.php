    ...
    public static function getAll(): array
    {
        return [
            [
                ...
                'url_media' => 'products/souvenir/souvenir-kotak.jpg',
                'categories' => ['Souvenir'],
            ],
            [
                ...
                'url_media' => 'products/souvenir/mug-custom.jpg',
                'categories' => ['Souvenir'],
            ],
            [
                ...
                'url_media' => 'products/souvenir/tas-kanvas.jpg',
                'categories' => ['Souvenir'],
            ],
            [
                'title' => 'Notebook Mini',
                ...
                'url_media' => 'products/souvenir/notebook.jpg',
                'categories' => ['Souvenir'],
            ],
            [
                ...
                'url_media' => 'products/souvenir/tempat-pensil.jpg',
                'categories' => ['Souvenir'],
            ],
            [
                ...
                'url_media' => 'products/souvenir/mini-pot.jpg',
                'categories' => ['Souvenir'],
            ],
        ];
    }
