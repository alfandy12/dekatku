    ...
    public static function getAll(): array
    {
        return [
            [
                ...
                'url_media' => 'products/tanaman/deliciosa.jpg',
                'categories' => ['Tanaman'],
            ],
            [
                ...
                'url_media' => 'products/tanaman/calathea.jpg',
                'categories' => ['Tanaman'],
            ],
            [
                ...
                'url_media' => 'products/tanaman/sansevieria.jpg',
                'categories' => ['Tanaman'],
            ],
            [
                ...
                'url_media' => 'products/tanaman/aglonema.jpg',
                'categories' => ['Tanaman'],
            ],
            [
                ...
                'url_media' => 'products/tanaman/philodendron.jpg',
                'categories' => ['Tanaman'],
            ],
        ];
    }
